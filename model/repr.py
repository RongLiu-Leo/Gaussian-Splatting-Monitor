...
class GaussianRepr(BaseModule):
    ...
    def update_params(self,param_dict):
        ...
        if "f_dc" in param_dict:
            self._features_dc = param_dict.get("f_dc")
        if "f_rest" in param_dict:
            self._features_rest = param_dict.get("f_rest")
        if "scaling" in param_dict:
            self._scaling = param_dict.get("scaling")
        if "rotation" in param_dict:
            self._rotation = param_dict.get("rotation")
        if "opacity" in param_dict:
            self._opacity = param_dict.get("opacity")
